...
- Ajoutez le secret d'environnement GitHub `TWITCH_ID_CLIENT` (Environment: `github-pages`).
- Le workflow `.github/workflows/deploy-pages.yml` injecte ce secret dans `client/runtime-config.js` au moment du déploiement.
